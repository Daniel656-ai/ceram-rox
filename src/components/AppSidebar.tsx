...
export function AppSidebar() {
  ...
  const navItems = [
    ...
    { title: "Fertigungsfreigaben", url: "/fertigungsfreigaben", icon: FileCheck2, show: hasPerm("production_releases.view") || hasPerm("production_releases.create") || role === "master", nav: "nav.production_releases" },
