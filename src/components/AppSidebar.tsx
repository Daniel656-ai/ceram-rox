...
export function AppSidebar() {
  ...
  const navItems = [
    ...
    { title: t("navigation:consumables"), url: "/verbrauchsmaterialien", icon: Package, show: (hasPerm("raw_materials.manage") || hasPerm("samples.view")) && role !== "durchfuehrer" },
    { title: t("navigation:work_planning"), url: "/arbeitsplanung", icon: CalendarDays, show: hasPerm("measurements.enter") },
    { title: t("navigation:lab_planning"), url: "/laborplanung", icon: Kanban, show: (hasPerm("measurements.view") || hasPerm("measurements.enter")) && role !== "durchfuehrer" },
    { title: t("navigation:templates"), url: "/templates", icon: Layers, show: hasPerm("orders.create") || isAdmin },
